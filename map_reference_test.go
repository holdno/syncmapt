...
type mapInterface[T comparable] interface {
	Load(T) (interface{}, bool)
	Store(key T, value interface{})
	LoadOrStore(key T, value interface{}) (actual interface{}, loaded bool)
	Delete(T)
	Range(func(key T, value interface{}) (shouldContinue bool))
}
